...
parser.add_argument("--study_uid_pattern",
                    default=r"[0-9\.]+\.[0-9\.]+")
parser.add_argument("--dataset_path",
                    required=True)
parser.add_argument("--patterns",nargs="+",type=str,
                    default=["*mha","*nii","*nii.gz"])
parser.add_argument("--image_type_pattern",
                    default=r"image_[a-zA-Z0-9]+")
parser.add_argument("--mask_path",default=None)
parser.add_argument("--mask_patterns",nargs="+",type=str,
                    default=["*mha","*nii","*nii.gz"])
parser.add_argument("--mask_type_pattern",
...
init_app(dataset_path=args.dataset_path,
